...
/* incomplete (nspring added because his L_CTRL is an R_CTRL) */
static const Keycode s_scanTableE0[] = {
    KEY_UNKNOWN, KEY_UNKNOWN, KEY_UNKNOWN, KEY_UNKNOWN, /* 0x00 - 0x03 */
    KEY_UNKNOWN, KEY_UNKNOWN, KEY_UNKNOWN, KEY_UNKNOWN, /* 0x04 - 0x07 */
    KEY_UNKNOWN, KEY_UNKNOWN, KEY_UNKNOWN, KEY_UNKNOWN, /* 0x08 - 0x0B */
    KEY_UNKNOWN, KEY_UNKNOWN, KEY_UNKNOWN, KEY_UNKNOWN, /* 0x0C - 0x0F */
    KEY_UNKNOWN, KEY_UNKNOWN, KEY_UNKNOWN, KEY_UNKNOWN, /* 0x10 - 0x13 */
    KEY_UNKNOWN, KEY_UNKNOWN, KEY_UNKNOWN, KEY_UNKNOWN, /* 0x14 - 0x17 */
    KEY_UNKNOWN, KEY_UNKNOWN, KEY_UNKNOWN, KEY_UNKNOWN, /* 0x18 - 0x1B */
    KEY_UNKNOWN, KEY_RCTRL, KEY_UNKNOWN, KEY_UNKNOWN,   /* 0x1C - 0x1F */
    KEY_UNKNOWN, KEY_UNKNOWN, KEY_UNKNOWN, KEY_UNKNOWN, /* 0x20 - 0x23 */
    KEY_UNKNOWN, KEY_UNKNOWN, KEY_UNKNOWN, KEY_UNKNOWN, /* 0x24 - 0x27 */
    KEY_UNKNOWN, KEY_UNKNOWN, KEY_UNKNOWN, KEY_UNKNOWN, /* 0x28 - 0x2B */
    KEY_UNKNOWN, KEY_UNKNOWN, KEY_UNKNOWN, KEY_UNKNOWN, /* 0x2C - 0x2F */
    KEY_UNKNOWN, KEY_UNKNOWN, KEY_UNKNOWN, KEY_UNKNOWN, /* 0x30 - 0x33 */
    KEY_UNKNOWN, KEY_UNKNOWN, KEY_UNKNOWN, KEY_UNKNOWN, /* 0x34 - 0x37 */
    KEY_RALT, KEY_UNKNOWN, KEY_UNKNOWN, KEY_UNKNOWN,    /* 0x38 - 0x3B */
    KEY_UNKNOWN, KEY_UNKNOWN, KEY_UNKNOWN, KEY_UNKNOWN, /* 0x3C - 0x3F */
    KEY_UNKNOWN, KEY_UNKNOWN, KEY_UNKNOWN, KEY_UNKNOWN, /* 0x40 - 0x43 */
    KEY_UNKNOWN, KEY_UNKNOWN, KEY_UNKNOWN, KEY_UNKNOWN, /* 0x44 - 0x47 */
    KEY_KPUP, KEY_KPPGUP, KEY_KPMINUS, KEY_KPLEFT,      /* 0x48 - 0x4B */
    KEY_KPCENTER, KEY_KPRIGHT, KEY_KPPLUS, KEY_KPEND,   /* 0x4C - 0x4F */
    KEY_KPDOWN, KEY_KPPGDN, KEY_KPINSERT, KEY_KPDEL,    /* 0x50 - 0x53 */
    KEY_UNKNOWN, KEY_UNKNOWN, KEY_UNKNOWN, KEY_UNKNOWN, /* 0x54 - 0x57 */
};
...
Keycode Wait_For_Key(void) {
    ...
    // see if we still have input from the qemu command line to hand off
    keycode = Get_Test_Input();
